...
# If non-interactive, don't do anything else
[ -z "$PS1" ] && return



########## PREDEFINED INTERACTIVE MODE TWEAKS ##########
...
# Have bash notify immediately about ended jobs
set -o notify


########## USER DEFINED INTERACTIVE MODE TWEAKS ##########
...
function taillast() { tail -f `ls -t --color=never $1 | head -1l | awk '{print $1}'`; }
function lesslast() { less `ls -t --color=never $1 | head -1l | awk '{print $1}'`; }
